...
rect(60, 50, 40, 30);  //horizontal rect for left eye
rect(70, 40, 20, 50);  //vertical rect for left eye
rect(120, 50, 40, 30); //horizontal rect for right eye
rect(130, 40, 20, 50); //vertical rect for right eye

//PUPILS
fill(0,0,255);         //fill blue for pupil
rect(60, 60, 20, 20);  //square rect for left pupil
rect(120, 60, 20, 20); //square rect for right pupil
