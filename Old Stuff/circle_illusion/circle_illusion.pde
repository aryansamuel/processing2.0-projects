/*
 * Author: Aryan Samuel, arsamuel@ucsc.edu
...
void draw() {
  ...
  stroke(140);            //grey stroke
  line(150,145,150,155);  //draw vertical cursor line
  line(145,150,155,150);  //draw horizontal cursor line
}
